...
class Speedfeedback10 : public ::apollo::drivers::canbus::ProtocolData<
                    ::apollo::canbus::Mt> {
 public:
 ...
 private:
    ...
    int linearspeedfeedback(const std::uint8_t* bytes, const int32_t length) const;
    ...
    double steeringanglefeedback(const std::uint8_t* bytes, const int32_t length) const;
};
