...
class MtController final : public VehicleController<::apollo::canbus::Mt> {
 public:
  ...
  ::apollo::common::ErrorCode Init(
      ...
      MessageManager<::apollo::canbus::Mt> *const message_manager) override;
 ...
 private:
  // control protocol
  Clearerrorstatus1* clear_error_status_1_ = nullptr;
